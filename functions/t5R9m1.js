t5R9m1.js// functions/t5R9m1.js
import {
  function but with GET
...
export async function onRequestGet(context) {
  ...
  try {
    ...
    return new Response(JSON.stringify(row || { aero: 7.5, tipoaereo: 1, fechaaereo: null, maritimo: 3, tipomaritimo: 1, fechamaritimo: null }), { headers: corsHeaders(origin) });
  } catch (e) {
